 ...
 * {@link GantiOliFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link GantiOliFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class GantiOliFragment extends Fragment {
     ...
     * @return A new instance of fragment GantiOliFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static GantiOliFragment newInstance(String param1, String param2) {
        GantiOliFragment fragment = new GantiOliFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ganti_oli, container, false);
...
//        lsbarang.setLayoutManager(layoutManager);
    ...
    public void getService(RecyclerView lsservice){
        ...
        categoryService.getGantiOli(motor.getIdmotor()).addValueEventListener(new ValueEventListener() {
            @Override
