 ...
 * {@link AnotherServiceFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AnotherServiceFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AnotherServiceFragment extends Fragment {
     ...
     * @return A new instance of fragment AnotherServiceFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static AnotherServiceFragment newInstance(String param1, String param2) {
        AnotherServiceFragment fragment = new AnotherServiceFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_anotherservice, container, false);
...
//        lsbarang.setLayoutManager(layoutManager);
    ...
    public void getService(RecyclerView lsservice){
        ...
        categoryService.getServiceLain(motor.getIdmotor()).addValueEventListener(new ValueEventListener() {
            @Override
